...
hr {
  ...
  <div class="elem-group">
    ...
    <select id="room-selection" name="house_number_3" >
  ...
  <button type="submit"   name="booking_button_3" class="signupbtn_2">Book The Rooms</button>
...
$(document).ready(function(){
	    ...
	    var date_range = <?php echo json_encode($datesArray_3); ?>;
